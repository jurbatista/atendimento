...
?>
				...
				<div id="formulario " class="">
					<div id="dadosAtendimento">
						<table>
							...
							pattern="[0-9]+$" value="<?=$received->telefone_cliente?>" required="required"></td>
							</tr>			
					...
					<table>
						...
						<tr>
							<td><input type="reset" value="Reiniciar" class="btn btn_zerar" ></td>							
							<td align="right"><input type="submit" value="Atualizar" class="btn btn_env"></td>
						</tr>
						</table>
	...
	<input type="text" name="id_atendente" value="<?=$_SESSION['id']?>" hidden="hidden">
	<input type="text" name="id_atd" value="<?=$received->id_atd?>" hidden="hidden">
	</form>
